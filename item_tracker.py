        ...
        while not done:
            ...
            if self.framecount % self.read_delay == 0:
                ...
                try:
                    ...
                    self.log_msg(
                        "log.txt not found, is the RebirthItemTracker directory in 'my games/Binding of Isaac Rebirth'?",
                        "D")
                    continue
                ...
                for current_line_number, line in enumerate(self.splitfile[self.seek:]):
                    ...
                    if line.startswith('Mom clear time:'):
                        ...
                        if self.current_room not in [x[0] for x in self.bosses]:
                            ...
                            len(self.bosses), self.suffix(len(self.bosses)), self.current_room, kill_time), "D")
